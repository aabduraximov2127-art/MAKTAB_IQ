...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "maktabiq"),
        "USER": os.getenv("POSTGRES_USER", "maktabiq"),
        "PASSWORD": os.getenv("POSTGRES_PASSWORD", "maktabiq"),
...
SPECTACULAR_SETTINGS = {
    "TITLE": "MaktabIQ API",
    "DESCRIPTION": "MaktabIQ — zamonaviy maktab boshqaruv va ta'lim platformasi REST API",
    "VERSION": "1.0.0",
