...
export default function HomeworkPage() {
  ...
  const isTeacher = canAny("create_homework", "manage_class_homework")
  const isStudent = canAny("submit_homework")
...
function AssignmentDrawer({ assignment, onClose }: { assignment: Assignment | null; onClose: () => void }) {
  const { canAny } = useAccess()
  const isStudent = canAny("submit_homework")
  const isTeacher = canAny("create_homework", "manage_class_homework", "grade_submissions")
